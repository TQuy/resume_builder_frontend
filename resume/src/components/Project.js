    ...
    render() {
        ...
        return (
            <li className="subSection">
                <div className='row'>
                        <input name="projectName" className='left-max' placeholder={`Project's name ${order}`} value={this.state.projectName} onChange={this.handleInputChange} />
                </div>
                <div className="details">
                    <textarea name="projectDetail" className='left-max' placeholder={`more details ${order}`} value={this.state.projectDetail} ref={this.textInput} onInput={this.handleInputChange} />
                </div>
            </li>
        )
    }
