    ...
    render() {
        ...
        return (
            <li className='subSection'>
                <ul>
                    <li><input name="companyPeriod" className="left-max" placeholder={`Working period ${order}`} value={this.state.companyPeriod} onChange={this.handleInputChange} /></li>
                    <li><input name="companyName" className="center-max" placeholder={`company's name ${order}`} value={this.state.companyName} onChange={this.handleInputChange} /></li>
                    <li><input name="companyPosition" className="right-max" placeholder={`position ${order}`} value={this.state.companyPosition} onChange={this.handleInputChange} /></li>
                    <li><textarea name="companyDetail" placeholder={`more details ${order}`} value={this.state.companyDetail} ref={this.textInput} onChange={this.handleInputChange} /></li>
                </ul>
            </li>
        )
    }
